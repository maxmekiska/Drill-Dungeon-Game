...
class NecromancerEnemy(Enemy, DiggingMixin, PathFindingMixin):
    ...
    def __init__(self, center_x: int, center_y: int, vision: Union[float, int],
        ...
        idle_textures = ["resources/images/enemy/necromancer_idle_anim_f0.png",
                         "resources/images/enemy/necromancer_idle_anim_f1.png",
                         "resources/images/enemy/necromancer_idle_anim_f2.png",
                         "resources/images/enemy/necromancer_idle_anim_f3.png"
                         ]

        moving_textures = ["resources/images/enemy/necromancer_run_anim_f0.png",
                           "resources/images/enemy/necromancer_run_anim_f1.png",
                           "resources/images/enemy/necromancer_run_anim_f2.png",
                           "resources/images/enemy/necromancer_run_anim_f3.png"
                           ]
